    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50/50 flex items-center justify-center">
      ...
      <section className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col items-center space-y-10 text-center">
        ...
        <header className="space-y-6">
          <h1 className="text-5xl font-bold tracking-tight sm:text-7xl bg-gradient-to-r from-gray-900 via-gray-700 to-gray-200 bg-clip-text text-transparent">
            Aetheria AI
          </h1>
          <p className="max-w-[600px] text-lg text-gray-600 md:text-xl/relaxed xl:text-2xl/relaxed">
            Discover the future of intelligence—a seamless fusion of advanced AI and intuitive design. Aetheria AI transcends conventional boundaries, empowering you to achieve extraordinary results with unparalleled ease.
            <br />
            <span className="text-gray-400 text-sm">
              Driven by IBM's WxTools and state-of-the-art LLMs.
            </span>
          </p>
        </header>
        {/* CTA Button */} 
        ...
        {/* Features grid */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-16 pt-8 max-w-3xl mx-auto">
          {[
            { title: "Effortless", description: "Real-time responses at your fingertips" },
            { title: "Visionary", description: "Built with cutting-edge technology" },
            { title: "Empowering", description: "Driven by your favorite LLMs" },
            {
              title: "Modern",
